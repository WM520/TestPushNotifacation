...
- (void)initDataBase {
    ...
    // 文件路径
    NSString *filePath = [[[[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:@"group.testpush"] absoluteString] stringByAppendingPathComponent:@"mynews.sqlite"];
